<script>
    ...
    function goToQuiz() {
      goto('/prinLecciones'); // Utiliza la barra al final para indicar el directorio
    }
  </script>
  ...
  <header>
    ...
    <span class="title">Serie Armónica</span>
  </header>
  <div class="carousel-container">
    ...
    <div>
      ...
      {#if index === gifs.length - 1}
        <button on:click={goToQuiz}>Volver a Lecciones</button>
      {/if}
    </div>
  </div>